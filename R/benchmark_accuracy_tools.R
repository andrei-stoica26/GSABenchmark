#' @importFrom hammers centerOfMass computeSilhouette metadataDF metadataNames nearestNeighbors normalizeSilhouette proximity safeMinmax scCol scPCAMat scExpMat shuffleGenes
