...
#' Perform a global evaluation benchmark on a set of gene set analysis method
#' scores
#'
#' This function performs a global evaluation benchmark on a set of gene set
...
#' Perform a direct MCC benchmark on a set of gene set analysis method scores
#'
#' This function performs a direct MCC benchmark on a set of gene set analysis
#' method scores.
#'
#' @inheritParams accuracyBenchmark
#'
#' @return A benchmark data frame with cells as row names, and labels,
#' gene set analysis scores, and MCC scores as columns.
#'
#' @keywords internal
#'
